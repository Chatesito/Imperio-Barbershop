...
function FooterItem({ icon, label, content }) {
    return (
        <div className="flex flex-col items-center text-center gap-1 group">
            ...
            <h3 className="text-white text-xs font-bold tracking-widest">{label}</h3>
            <div className="text-neutral-400 text-xs leading-normal group-hover:text-white transition-colors">
                {content}
            </div>
        </div>
    );
            ...
            <div className="max-w-7xl mx-auto px-8 md:px-16 lg:px-24 py-6 text-center space-y-4">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-2">
                    <div className="text-center md:text-left">
                        <h2 className="text-3xl md:text-4xl font-karantina font-semibold text-white uppercase tracking-wider">CONTÁCTANOS</h2>
                    </div>
                </div>
                        ...
                        content={
                            <>
                                ...
                                <a
                                    ...
                                    className="text-brand-gold hover:text-white underline underline-offset-4 transition-colors block mt-1 font-medium text-[10px]"
                                >
                                    Ver todas las sedes
                                </a>
                            </>
                ...
                {/* --- Línea divisoria --- */}
                <div className="h-px my-2 bg-gradient-to-r from-transparent via-brand-gold to-transparent opacity-50" />
                ...
                {/* --- Derechos reservados --- */}
                <p className="text-neutral-500 text-[10px] tracking-wide mt-1">
