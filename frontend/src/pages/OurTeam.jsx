...
function TeamCard({ img, name, role, bio }) {
    return (
        <article className="relative rounded-[2.5rem] overflow-hidden group border border-neutral-800 shadow-2xl">
            {/* Imagen limpia */}
            ...
            {/* Overlay gradiente */}
            <div className="absolute inset-0 bg-gradient-to-t from-neutral-950 via-neutral-950/40 to-transparent opacity-95" />
            ...
            <div className="relative z-10 p-8 pt-64 min-h-[460px] flex flex-col justify-end">
                <div>
                    ...
                    <h3 className="text-white font-karantina font-semibold text-4xl leading-none uppercase mb-4">{name}</h3>
        ...
        <main className="bg-neutral-950 text-white selection:bg-brand-gold selection:text-neutral-950">
            ...
            <section className="relative py-24 px-6 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto text-center space-y-4 animate-fade-in-up">
                    ...
                    <h1 className="text-6xl md:text-8xl font-semibold font-karantina uppercase leading-[0.8] tracking-tighter">
                        NUESTRO <br />
                ...
                <div className="max-w-7xl mx-auto px-6 grid gap-12 md:grid-cols-3 text-center">
                    {[
                        ...
                        <div key={i} className="space-y-4 group">
                            ...
                            <div className="text-5xl md:text-7xl font-karantina font-semibold text-white tracking-tight">{stat.value}</div>
            ...
            <section className="py-32 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-20 space-y-4">
                        ...
                        <h3 className="text-4xl md:text-6xl font-karantina font-semibold text-white uppercase leading-none">GALERÍA DEL <span className="text-brand-gold">TRONO</span></h3>
                    </div>
