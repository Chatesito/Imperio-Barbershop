...
export default function Footer() {
    return (
        <footer className="bg-gradient-to-b from-neutral-900 to-neutral-950 border-t border-brand-gold/20 text-neutral-300">
            <div className="max-w-7xl mx-auto px-4 py-8 text-center space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 mt-4">
                    <FooterItem
                ...
                {/* --- Línea divisoria --- */}
                <div className="h-px my-4 bg-gradient-to-r from-transparent via-brand-gold to-transparent opacity-50" />
                ...
                {/* --- Derechos reservados --- */}
                <p className="text-neutral-500 text-xs tracking-wide mt-2">
